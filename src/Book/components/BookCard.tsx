...
export function BookCard() {
  return (
    <div class="relative h-72 w-56 shadow-lg">
      <article class="absolute z-20 flex h-full w-full flex-col items-center justify-between rounded-md rounded-bl-none border-4 border-l-0 border-primary bg-neutral p-2">
        ...
        <footer class={'flex w-full items-center justify-between gap-x-2'}>
          <HICheckBadge class="h-12 w-12 text-primary" />
      ...
      <div class="absolute left-[6px] top-2 z-10 h-full w-full scale-105 rounded-md rounded-bl-none border-4 border-primary bg-green-300" />
    </div>
  );
}
