...
export function Button(props: ButtonProps) {
  ...
  return (
    <button
      class={strUtil.cx(
        `relative rounded-sm border ring-2 ring-black-900/5 ring-offset-1 ring-offset-black-500/20 px-4 py-2 transition-colors disabled:bg-gray-500 disabled:text-gray-700`,
...
const filledMap = {
  ...
  danger: 'text-black-50 bg-red-600 border-red-500 hover:bg-red-800 active:bg-red-900',
};
...
const classMap: Record<Modes, Record<Themes, string>> = {
  ...
  fab: filledMap,
  stroked: {
    primary: 'bg-green-50 text-green-800 border-green-500 hover:bg-green-100 active:bg-green-200',
    danger: 'bg-red-50 text-red-800 border-red-500 hover:bg-red-100 active:bg-red-200',
  },
};
